...
<template>
  <header id="header" class="bg-[rgb(14,33,58)] shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <div class="flex justify-between items-center">
        <div class="flex items-center">
          <!-- <i class="fa-solid fa-flask-vial text-[rgb(236,0,140)] text-2xl mr-3"></i> -->
          <img src="/logo.svg" alt="Open Health Logo" class="h-8 w-8 mr-3" />
